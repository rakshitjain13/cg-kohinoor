  ...
  return (
    <>
      <Block factor={1} offset={0}>
        ...
        <Block factor={1.0}>
          <Dom position={[-w / 3.2, -w * 0.08 + 0.25, -1]}>It was the year 1852.{mobile ? <br /> : " "}The substance had arrived 13ft below.</Dom>
        </Block>
      </Block>
      <Block factor={1.2} offset={5.7}>
        <MultilineText top left size={w * 0.15} lineHeight={w / 5} position={[-w / 3.5, 0, -1]} color="#2fe8c3" text={"for\nreal\nyou"} />
      </Block>
