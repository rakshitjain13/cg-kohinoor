  ...
  paragraphs: [
    {
      ...
      factor: 1.75,
      header: "Mining",
      image: "https://images.unsplash.com/photo-1586161148512-64a1b3dac527?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=843&q=80",
      aspect: 1.51,
      text: "Diamond-bearing ore and gravel is collected and transferred to a primary crusher, which is responsible for reducing the larger pieces of ore into smaller pieces that measure no larger than 150mm, and are much more manageable."
    },
    {
      offset: 2,
      factor: 2.0,
